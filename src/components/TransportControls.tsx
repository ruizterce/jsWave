...
const TransportControls: React.FC<TransportControlsProps> = ({
  ...
  return (
    <div className="relative flex gap-2 w-full justify-center items-center bg-lightMedium  rounded-2xl p-2">
      ...
      >
        <img
          src={`${import.meta.env.VITE_ASSET_URL}/assets/icons/play_arrow.svg`}
          alt="Play"
      ...
      >
        <img
          src={`${import.meta.env.VITE_ASSET_URL}/assets/icons/pause.svg`}
          alt="Pause"
          className={`brightness-0 ${
            Tone.getTransport().state !== "started" ? "invert" : ""
          }`}
      ...
      >
        <img
          src={`${import.meta.env.VITE_ASSET_URL}/assets/icons/stop.svg`}
          alt="Stop"
          className={`brightness-0 ${
